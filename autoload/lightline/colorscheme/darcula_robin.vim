...
let s:normal=s:fg
let s:onNormal=s:bg
let s:visual=darcula#palette.UIBlue
let s:onVisual=s:bg
let s:insert=darcula#palette.UIGreen
let s:onInsert=s:bg
let s:replace=darcula#palette.keyword
let s:onReplace=s:bg
...
let g:lightline#colorscheme#darcula_robin#palette = lightline#colorscheme#flatten(s:p)
